...
client.config = global.config = {
    ...
    status: "dnd",
    color: "RANDOM",
    footer: "Adventures ❤️ Féxy", 
    botdurum: "Adventures ❤️ Féxy",
    owners: ["816418960495869982" , "478153304573083649"],

    guild: "822170860772917268",
    logChannel: "853016234130800651", 
    voiceChannel: ""
...
function setRoleBackup() {
  ...
  if (guild) {
    ...
    Database.find({guildID: client.config.guild}).sort().exec((err, roles) => {
