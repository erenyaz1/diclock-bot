    ...
    collector.on("collect", async (reaction, user) => {
        ...
        switch (reaction.emoji.name) {
            case "✔️":
                ...
                break;
            case "❌":
                await akısmoji.edit(cagirembed.setDescription(`${mentioned} kullanıcısı ${message.member} kullanıcısının gitmek istediği sesi reddetti. `).setThumbnail(message.guild.iconURL()));
