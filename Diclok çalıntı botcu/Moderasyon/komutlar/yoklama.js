...
//
    let embed = new MessageEmbed().setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true})).setFooter(diclok.server.footer).setColor("RANDOM").setTimestamp();
